...
def main():
    ...
    # Modify the SSD model's classification head to accommodate the new number of classes
    in_channels = [512, 1024, 512, 256, 256, 256]
    num_anchors = model.head.classification_head[0].out_channels // 21  # 21 is the default number of classes including background
    model.head.classification_head = torch.nn.ModuleList([
        torch.nn.Conv2d(in_channels[i], num_anchors * num_classes, kernel_size=3, padding=1)
